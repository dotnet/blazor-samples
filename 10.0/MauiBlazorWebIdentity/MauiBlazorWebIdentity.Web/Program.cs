...
using MauiBlazorWebIdentity.Web.Components;
using MauiBlazorWebIdentity.Web.Components.Account;
using MauiBlazorWebIdentity.Web.Data;
using MauiBlazorWebIdentity.Web.Services;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(MauiBlazorWebIdentity.Shared._Imports).Assembly);
