...
* Blazor Web App with Entra (`BlazorWebAppEntra`): [Secure an ASP.NET Core Blazor Web App with Microsoft Entra](https://learn.microsoft.com/aspnet/core/blazor/security/blazor-web-app-with-entra)
